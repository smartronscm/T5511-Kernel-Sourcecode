...
#define FMDBG(fmt, args...) pr_err("silabs_radio: " fmt, ##args)
...
/* divide_frequency */
#define FM_divide_frequency 0x258//0x0249

/* SET_frequency */
#define FM_set_work_frequency 0x7D00//0x7FFC
